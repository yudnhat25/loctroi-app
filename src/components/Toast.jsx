const Toast = ({ message }) => {
  ...
  return (
    <div className="fixed bottom-20 right-6 z-50 fade-in select-none">
      <div className={`bg-slate-900 text-white px-4 py-3 rounded-xl ring-1 ${tone.ring} shadow-[0_12px_32px_-12px_rgba(15,23,42,0.5)] flex items-start gap-3 min-w-[260px] max-w-sm`}>
        ...
        <span className="leading-snug text-[14px] font-medium">{clean}</span>
      </div>
    </div>
  );
};
